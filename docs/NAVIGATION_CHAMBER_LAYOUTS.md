...
- Start with a small pilot on every training map, inspect the MP4s and action alignment, then collect a balanced number of successful runs per map. A rough initial target is 10–20 good demonstrations on each new training chamber, not another 200 on one layout.
